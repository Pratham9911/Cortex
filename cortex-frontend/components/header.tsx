    ...
    <header className="w-full py-4 px-6">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-6">
         <div className="flex items-center right-3 gap-3 h-12 relative">
  <img
    src="/smallicon.png"
    alt="Cortex Logo"
    className="w-20 h-22 object-contain absolute   top-7 -translate-y-1/2"
  />
  <span className="text-foreground text-xl font-semibold ml-16">Cortex</span>
</div>
